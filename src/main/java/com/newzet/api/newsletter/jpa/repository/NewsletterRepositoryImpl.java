...
public class NewsletterRepositoryImpl implements NewsletterRepository {
	...
	@Override
	public NewsletterImageUrlCacheDto findNewsLetterImageUrlByDomainAndMailingList(String domain, String mailingList) {
		String imageUrl = jpaRepository.findImageUrlByDomainOrMailingList(
			domain, mailingList);
		if (imageUrl == null) {
